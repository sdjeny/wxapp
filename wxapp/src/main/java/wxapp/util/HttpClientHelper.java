...
public class HttpClientHelper {
	...
	public static String proxyIp = null;// "10.180.162.66";
...
//		}
	...
	public String doPost(String url) {
		return doPost(url, new HashMap<>(), false);
	}
	 ...
	 * @return
	 */
	public String doPost(String url, Map<String, Object> params, boolean isJson) {
		String result = null;
		...
		try {
			if (isJson) {
				httpPost.setEntity(new StringEntity(JsonFactory.toJson(params), Charset.forName("UTF-8")));
			} else {
